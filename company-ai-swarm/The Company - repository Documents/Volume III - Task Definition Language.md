...
A Task is an Enterprise Object representing a bounded objective with measurable completion criteria.
...
Each Task SHALL receive independent risk scores.
...
Every completed Task SHALL provide evidence.
...
The COO SHALL schedule Tasks according to:
...
Tasks MAY execute simultaneously when:
...
A Task SHALL escalate whenever:
