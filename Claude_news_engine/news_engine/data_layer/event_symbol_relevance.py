...
_RELEVANCE_TABLE: dict[tuple[str, str], RelevanceJudgment] = {
    ...
    ("ISM Manufacturing PMI", "US30"): RelevanceJudgment(
        RelevanceStatus.RELEVANT,
        "CORRECTED 2026-09-16 after review found the prior version's "
        "shared MarketPulse citation misattributed -- direct WebFetch of "
        "that exact URL confirmed the article is dated Aug 21 2025 (a "
        "year earlier than claimed) and covers a different PMI print "
        "(53.3 vs 49.5, not the claimed 54.6 vs 55.3); it has been "
        "dropped entirely, not reused for any symbol. Internal, real, "
        "live-logged evidence from this project's own scoring DB "
        "(scoring/backtest_log.db, outcomes table) remains unaffected and "
        "still stands on its own: 2 real ISM Manufacturing PMI "
        "occurrences logged against US30 with Dukascopy-measured 30-min "
        "moves -- 2026-03-02: +0.23%, 2026-09-01: +0.41% (both bullish, "
        "the 2026-09-01 move timed to the release itself). Separately "
        "verified, real, dated WebSearch for the FULL-DAY close on that "
        "same 2026-09-01 session (the Aug print, 54.6 vs 55.2/55.3 "
        "consensus, a miss): the Dow actually CLOSED down 419.02 points "
        "(-0.8%) to 52,766.88, with 'softer-than-expected ISM "
        "Manufacturing and JOLTS data tak[ing] a back seat as geopolitical "
        "and inflation concerns dominated the session' (CNBC, 'Stock "
        "market news for Sept. 1, 2026', cnbc.com/2026/08/31/stock-market-"
        "today-live-updates.html) -- this is not a contradiction of the "
        "internal DB row (a 30-min release-timed reaction vs. a full-day "
        "close dominated by later, unrelated news) but is flagged "
        "honestly here since it shows ISM was NOT the day's dominant "
        "driver by the close. A separate, cleaner real instance exists: "
        "Aug 3 2026 (July print, 55.6 vs 54.0 forecast, a clear beat, "
        "best since May 2022) -- the Dow closed up 907.47 points (+1.71%) "
        "to a record 54,085.88 (CNBC, 'Dow surges 900 points, S&P 500 "
        "closes above 7,700 for first time in booming Wall Street rally', "
        "cnbc.com/amp/2026/08/03/stock-market-today-live-updates.html), "
        "with the ISM beat named as one of several real, concurrent "
        "drivers alongside Big Tech earnings (Amazon crossing $3T market "
        "cap) and easing US-Iran tension (Yahoo Finance, same-day live "
        "blog, finance.yahoo.com/markets/live/stock-market-today-monday-"
        "august-3-dow-sp-500-nasdaq-big-tech-oil-092516872.html) -- real "
        "and ISM-specific, though confounded, not isolated",
    ),
    ("ISM Manufacturing PMI", "US500"): RelevanceJudgment(
        RelevanceStatus.RELEVANT,
        "CORRECTED 2026-09-16 -- same MarketPulse misattribution as the "
        "US30 entry above; that citation is dropped here too. Real, "
        "dated WebSearch, re-verified directly: Aug 3 2026 (July print, "
        "55.6 vs 54.0 forecast, a beat, best since May 2022) -- the S&P "
        "500 closed up 1.79% to 7,736.52, its first close above 7,700 "
        "(CNBC, 'Dow surges 900 points, S&P 500 closes above 7,700 for "
        "first time in booming Wall Street rally', cnbc.com/amp/2026/"
        "08/03/stock-market-today-live-updates.html; a same-day Yahoo "
        "Finance live blog gives a slightly different intraday snapshot, "
        "+1.5%, consistent with a live-updating article rather than a "
        "conflicting account). The ISM report is explicitly named as a "
        "positive driver alongside Big Tech strength (Nvidia's $5T market "
        "cap, Microsoft/Amazon earnings) and US-Iran diplomacy easing oil "
        "prices (finance.yahoo.com/markets/live/stock-market-today-"
        "monday-august-3-dow-sp-500-nasdaq-big-tech-oil-092516872.html) -- "
        "real and ISM-specific, though one of several named same-day "
        "drivers, not isolated. Also corroborated by the "
        "Layer2_Asset_Transmission sheet's own equity-indices row: a real "
        "backtest finding that 'a naive buy S&P 500 whenever ISM PMI > 50 "
        "rule actually UNDERPERFORMED plain buy-and-hold (7.3% vs 8.5% "
        "annual return)' -- real evidence ISM reaches this symbol even "
        "though a simple threshold rule isn't a validated edge",
    ),
    ("ISM Manufacturing PMI", "NAS100"): RelevanceJudgment(
        RelevanceStatus.UNVERIFIED,
        "CORRECTED 2026-09-16 -- same MarketPulse misattribution as the "
        "US30/US500 entries above; that citation is dropped here too, "
        "which also resolves (by removal) the Composite-vs-NAS100 "
        "substitution this entry previously, self-flagged. Real, dated "
        "Nasdaq COMPOSITE evidence exists and is real (e.g. Aug 3 2026, "
        "same July-ISM-beat session as the US30/US500 entries: Composite "
        "+2.59% to 26,584.99, CNBC/Yahoo, same URLs as those entries), "
        "but a specific search for NAS100 (the futures/index instrument "
        "this table actually tracks, distinct from the Composite) on "
        "that same date and on the Sep 1 2026 date turned up no dated "
        "article isolating a NAS100-specific ISM reaction -- Vantage "
        "Markets' own daily NAS100 analysis series exists for many "
        "nearby dates (e.g. 'NAS100 Rebounds to 29,530 as Fed Hike Odds "
        "Hit 66%', Sep 1 2026, vantagemarkets.com/market-analysis/nas100-"
        "nasdaq-analysis-september-1-2026/) but frames that day's move "
        "around Fed-hike-odds repricing generally, not the ISM print "
        "specifically, and no equivalent piece was found for Aug 3 2026. "
        "Per the review's instruction: marking this UNVERIFIED with an "
        "honest note rather than silently substituting Composite data or "
        "reasoning by analogy from the Composite's own real reaction",
    ),
